    ...
    <div className="min-h-screen bg-gray-50 flex">
      ...
      <div className="flex-1 p-4">
        <div className="bg-white rounded-lg shadow-sm h-full">
          ...
          <div className="p-8 text-center text-gray-500">Canvas Area</div>
        </div>
      </div>

      {/* Right sidebar - Refactored StuffPanel */}
      <div className="w-80 bg-white border-l border-gray-200">
        <RefactoredStuffPanel defaultTab="layouts" className="flex h-full flex-col" />
      </div>
    </div>
  );
}
    ...
    <div className="w-80 bg-white border-l border-gray-200 flex flex-col">
      ...
      <div className="flex-1 p-4">
        <div className="space-y-4">
          <TabButton label="Layouts" isActive={activeTab === "layouts"} onClick={() => setActiveTab("layouts")} />
          <TabButton label="Themes" isActive={activeTab === "themes"} onClick={() => setActiveTab("themes")} />
