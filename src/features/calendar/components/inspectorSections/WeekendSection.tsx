    ...
    <div className="grid grid-cols-2 gap-3">
      <FormGroup label="Text" id={ids.weekendText} inline className="min-w-0">
        <ColorInputWithReset
          id={ids.weekendText}
          value={
            userCalendarStyles.weekendCellTextColor ||
            effective.weekendCellTextColor ||
            effective.cellTextColor ||
            "#1f2937"
          }
      ...
      <FormGroup label="Background" id={ids.weekendBg} inline className="min-w-0">
        <ColorInputWithReset
          id={ids.weekendBg}
          value={
            userCalendarStyles.weekendCellBackgroundColor ||
            effective.weekendCellBackgroundColor ||
            `${theme.styles.title.color || "#3B82F6"}20`
          }
