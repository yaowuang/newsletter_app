...
import type { ImageElementType, SectionStylesType, TextBlockType } from "@/features/newsletter/types";
...
import type { CalendarData as CalendarDataType } from "../calendar";

// Import any initializers needed for state
import { buildInitialBlocks } from "../initialData";
import { type CalendarSlice, createCalendarSlice, initializeCalendarData } from "./calendarSlice";
import { createHorizontalLineSlice, type HorizontalLineSlice } from "./horizontalLineSlice";
...
export type RootStore = NewsletterSliceType &
  ImageSlice &
  HorizontalLineSlice &
  CalendarSlice &
  SelectionSlice &
