...
import type { CalendarData, CalendarEvent, CalendarStylesType } from "@/features/calendar/types";
...
export interface CalendarSlice {
  ...
  setCalendarStyle: (styleKey: keyof CalendarStylesType, value: string | number | undefined) => void;
  setCalendarStyles: (styles: Partial<CalendarStylesType>) => void;
...
export const createCalendarSlice: StateCreator<CalendarSlice, [], [], CalendarSlice> = (set) => ({
  ...
  setEditingDateKey: (key: string | null) =>
    set((state) => ({
  ...
  setCellContent: (dateKey: string, content: string) =>
    set((state) => ({
      calendarData: {
        ...state.calendarData,
        cellContents: {
  ...
  setCalendarStyle: (styleKey, value) =>
    set((state) => ({
      calendarData: {
        ...state.calendarData,
        calendarStyles: {
