...
export const metadata: Metadata = {
  ...
  description:
    "Create engaging elementary school newsletters in minutes. Drag-and-drop sections, kid-friendly themes, instant PDF / PNG / SVG export. Free, no login.",
  keywords: [
    "elementary school newsletter",
    "classroom newsletter builder",
    "newsletter templates for teachers",
    "school newsletter export PDF",
    "free school newsletter tool",
  ],
  ...
  openGraph: {
    ...
    description:
      "Free drag-and-drop builder for engaging elementary school newsletters. Themes, emojis, instant exports.",
    images: [
      {
...
export default function LandingPage() {
  return (
    <div className="relative min-h-screen w-full overflow-hidden bg-gradient-to-br from-[#0c1220] via-[#101a32] to-[#1b2240] text-slate-100 selection:bg-blue-500/30">
      ...
      <a
        href="#main"
        className="sr-only focus:not-sr-only focus:absolute focus:top-2 focus:left-2 focus:z-50 focus:px-4 focus:py-2 focus:rounded-md focus:bg-slate-900 focus:text-white"
      >
        Skip to content
      </a>
            ...
            __html: JSON.stringify([
              {
                ...
                operatingSystem: "Web",
                description:
                  "Free drag-and-drop elementary school newsletter builder with themes and instant PDF, PNG, SVG export.",
                ...
                mainEntity: [
                  {
                    ...
                    acceptedAnswer: {
                      "@type": "Answer",
                      text: "Yes – all core features are available.",
                    },
                  },
                  {
                    "@type": "Question",
                    ...
                    acceptedAnswer: {
                      "@type": "Answer",
                      text: "No account or login required. Open & build instantly.",
                    },
                  },
                  {
                    "@type": "Question",
                    name: "iPad compatible?",
                    acceptedAnswer: {
                      "@type": "Answer",
                      text: "Yes. Panels & drag interactions support touch.",
                    },
                  },
                  {
                    "@type": "Question",
                    ...
                    acceptedAnswer: {
                      "@type": "Answer",
                      text: "Export PNG / SVG / PDF and embed or send anywhere.",
                    },
                  },
                ],
              },
  ...
  return (
    <header className="sticky top-4 z-40 max-w-7xl mx-auto px-5 py-4 flex items-center justify-between backdrop-blur-xl bg-white/5 border border-white/10 rounded-2xl shadow-[0_4px_24px_-4px_rgba(0,0,0,0.5)] ring-1 ring-white/10">
      <div className="flex items-center gap-3">
        <Logo />
        <span className="font-semibold tracking-tight text-lg sm:text-xl bg-gradient-to-r from-sky-300 via-indigo-300 to-fuchsia-300 bg-clip-text text-transparent">
      ...
      <div className="flex items-center gap-3">
        <Link
          href="/builder"
          className="inline-flex items-center rounded-xl bg-gradient-to-r from-blue-600 via-indigo-600 to-purple-600 text-white px-5 py-2.5 text-sm font-semibold shadow-[0_6px_28px_-6px_rgba(59,130,246,0.55)] hover:from-blue-500 hover:via-indigo-500 hover:to-purple-500 focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-400/60"
        >
          Launch Builder <span className="ml-1">→</span>
        </Link>
      </div>
    </header>
  );
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 flex flex-col gap-14">
        ...
        <div className="max-w-3xl mx-auto text-center">
          <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-white/5 ring-1 ring-white/10 backdrop-blur-sm mb-6 text-[11px] font-medium tracking-wide text-slate-300 shadow-inner shadow-white/5">
            <span className="h-1.5 w-1.5 rounded-full bg-gradient-to-r from-blue-400 to-purple-400 animate-pulse" />{" "}
            New: PDF & SVG Export
          </div>
          <h1 id="hero-heading" className="text-5xl md:text-6xl font-extrabold tracking-tight leading-[1.05]">
            Build{" "}
            <span className="relative inline-block">
              <span className="bg-gradient-to-r from-blue-400 via-indigo-400 to-fuchsia-400 bg-clip-text text-transparent">
                newsletter magic
              </span>
              <span
                aria-hidden
                className="pointer-events-none absolute -inset-1 rounded-lg blur-md opacity-25 bg-gradient-to-r from-blue-500 via-indigo-500 to-fuchsia-500"
              />
            </span>{" "}
            in minutes
          </h1>
          <p className="mt-6 text-lg text-slate-300/90 max-w-[50ch] mx-auto leading-relaxed">
            A focused dark‑mode <strong className="font-semibold">elementary school newsletter builder</strong> for
            classrooms. Craft, style & share weekly updates with ready-made templates—no logins, no clutter.
          </p>
          <p className="mt-4 text-sm text-slate-400 max-w-[60ch] mx-auto leading-relaxed">
            Create a free classroom newsletter, reuse last week’s layout, and export polished PDFs, PNG or SVG files in
            seconds. Perfect for teachers needing a simple, accessible school newsletter template.
          </p>
          <div className="mt-9 flex flex-wrap justify-center gap-4">
            <Link
              href="/builder"
              className="group inline-flex items-center gap-2 rounded-xl px-7 py-3.5 text-sm font-semibold bg-gradient-to-r from-blue-600 via-indigo-600 to-purple-600 shadow-[0_8px_30px_-6px_rgba(59,130,246,0.55)] hover:shadow-[0_8px_34px_-4px_rgba(99,102,241,0.55)] transition"
            >
              Start Free <span className="text-base translate-x-0 group-hover:translate-x-0.5 transition">→</span>
            </Link>
            <a
              href="#features"
              className="inline-flex items-center rounded-xl px-7 py-3.5 text-sm font-medium bg-white/7 ring-1 ring-white/15 hover:bg-white/10 transition"
            >
              See Features
            </a>
          </div>
          <ul className="mt-6 flex flex-wrap justify-center gap-5 text-[11px] uppercase tracking-wider text-slate-500">
            {["No Login", "Instant Export", "Accessible", "Free Forever"].map((t) => (
              <li key={t}>{t}</li>
            ))}
          </ul>
        </div>
...
function Features() {
  return (
    <section
      id="features"
      className="py-28 border-t border-b border-white/10 bg-gradient-to-b from-slate-900/40 to-slate-950/60"
      aria-labelledby="features-heading"
    >
      <div className="max-w-7xl mx-auto px-6">
        <h2 id="features-heading" className="text-3xl md:text-4xl font-bold mb-14 text-center tracking-tight">
          Key Features
        </h2>
        <div className="grid md:grid-cols-3 gap-8 md:gap-10">
          {[
            {
              title: "Live Section Styling",
              desc: "Adjust fonts, borders, colors & backgrounds with instant visual feedback.",
            },
            {
              title: "Smart Headings",
              desc: "Auto-suggested common classroom section titles as you type.",
            },
            {
              title: "Drag & Arrange",
              desc: "Intuitive panel layout with resizable columns.",
            },
            {
              title: "Emojis & Icons",
              desc: "Curated palette for kid-friendly engagement & emphasis.",
            },
            {
              title: "Theme System",
              desc: "Holiday & seasonal styles to keep things fresh.",
            },
            {
              title: "Export Suite",
              desc: "Download PNG, SVG, PDF or project (.enl) files.",
            },
          ].map((f, i) => (
            <div
              key={f.title}
              className="relative group p-6 rounded-2xl bg-white/[0.04] border border-white/10 hover:border-white/25 transition overflow-hidden shadow-[0_1px_0_0_rgba(255,255,255,0.05)_inset]"
            >
              ...
              <div className="relative">
                <div
                  className="mb-4 h-9 w-9 rounded-lg bg-gradient-to-br from-blue-500/30 to-indigo-500/30 flex items-center justify-center ring-1 ring-white/20 text-slate-200 text-sm font-semibold"
                  aria-hidden
                >
                  {i + 1}
                </div>
                {f.title === "Drag & Arrange" ? (
                  <h3 className="font-semibold mb-2 text-base text-white tracking-tight">
                    <Link
                      href="/builder"
                      className="underline decoration-dotted underline-offset-4 hover:text-sky-300 focus:outline-none"
                    >
                      {f.title}
                    </Link>
                  </h3>
  ...
  return (
    <section id="value" className="py-32" aria-labelledby="value-heading">
      <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-20 items-start">
        <div>
          <h2 id="value-heading" className="text-3xl font-bold mb-10 tracking-tight">
          ...
          <ol className="relative ml-2 border-l border-white/10 pl-6 space-y-8">
            {[
              ...
              {
                t: "Engaging",
                d: "Colors, emojis & themes boost student attention.",
              },
              {
                t: "Accessible",
                d: "Readable fonts & hierarchy tuned for young readers.",
              },
              { t: "Reusable", d: "Load last week’s .enl and update quickly." },
              { t: "Shareable", d: "Export images / PDF for email or print." },
              {
                t: "Teacher‑Centric",
                d: "No clutter, no accounts, zero data collection.",
              },
            ].map((item) => (
          ...
          <p className="mt-8 text-xs text-slate-400 max-w-[50ch]">
            Want to try it now? Explore the{" "}
            <Link
              href="/builder"
              className="text-sky-300 underline decoration-dotted underline-offset-2 hover:text-sky-200"
            >
              free classroom newsletter builder
            </Link>{" "}
            and publish today.
          </p>
        </div>
        <div id="faq" className="grid gap-6">
          ...
          {[
            { q: "Is it free?", a: "Yes – all core features are available." },
            {
              ...
              a: "No account or login required. Open & build instantly.",
            },
            {
              q: "iPad compatible?",
              a: "Yes. Panels & drag interactions support touch.",
            },
            {
              q: "How do I share?",
              a: "Export PNG / SVG / PDF and embed or send anywhere.",
            },
          ].map((item) => (
            <div
              key={item.q}
              className="p-5 rounded-2xl border border-white/10 bg-white/[0.045] backdrop-blur shadow-sm"
            >
          ...
          <Link
            href="/builder"
            className="inline-flex items-center justify-center rounded-xl bg-gradient-to-r from-blue-600 via-indigo-600 to-purple-600 text-white px-6 py-3 text-sm font-semibold shadow hover:from-blue-500 hover:via-indigo-500 hover:to-purple-500 transition mt-4"
          >
  ...
  return (
    <section className="relative py-36" aria-labelledby="cta-heading">
      ...
      <div className="max-w-3xl mx-auto px-6 text-center">
        <h2 id="cta-heading" className="text-4xl font-bold mb-6 tracking-tight">
          Ready to publish your next update?
        </h2>
        <p className="text-slate-400 mb-10 max-w-[56ch] mx-auto">
          Compose, style & export in under ten minutes. No barriers. Build an elementary school newsletter your class
          families actually read.
        </p>
        <Link
          href="/builder"
          className="inline-flex items-center rounded-2xl bg-gradient-to-r from-blue-600 via-indigo-600 to-purple-600 text-white px-10 py-4 text-base font-semibold shadow-[0_8px_34px_-6px_rgba(59,130,246,0.55)] hover:from-blue-500 hover:via-indigo-500 hover:to-purple-500 transition"
        >
          Launch the Builder
        </Link>
